...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  toggleRemote: () => ipcRenderer.send('toggle-remote'),
  getRemoteStatus: () => ipcRenderer.invoke('get-remote-status'),
  onRemoteStatus: (callback: (data: any) => void) => onIPC('remote-status', (_event: any, data: any) => callback(data)),
  ...
  sendABCompChannelUpdate: (data: any) => ipcRenderer.send('ab-comp-channel-update', data),
  ...
  onABCompChannelUpdate: (callback: (data: any) => void) => onIPC('ab-comp-channel-update', (_event: any, data: any) => callback(data)),
